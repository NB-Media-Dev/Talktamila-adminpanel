...
export function Performanceacrossplatform() {
  ...
  return (
    <div className="fixed inset-0 top-[52px] xs:top-[56px] sm:top-[60px] md:top-0 bg-black/50 backdrop-blur-xs flex items-start md:items-center justify-center p-0 md:p-4 z-40">
      <div className="w-full h-[calc(100vh-56px)] md:h-[560px] md:max-w-[820px] rounded-none md:rounded-[28px] bg-white shadow-2xl relative font-sans antialiased border-0 md:border border-orange-100 flex flex-col overflow-hidden">
