    ...
    <div className="fixed inset-0 bg-black/55 backdrop-blur-xs flex items-center justify-center p-0 md:p-4 z-40 animate-fade-in select-none">
      ...
      <div className="w-full h-full md:h-auto md:max-h-[85vh] md:max-w-[760px] rounded-none md:rounded-3xl bg-[#FAF3EC] shadow-2xl px-4 pt-[calc(3.5rem+env(safe-area-inset-top,0px))] pb-28 md:px-5 md:py-5 relative font-sans antialiased border-0 md:border border-orange-100/40 overflow-y-auto md:overflow-hidden flex flex-col gap-3">
        ...
        <div className="flex items-center justify-between border-b border-orange-100/60 pb-2">
          ...
          <button
            onClick={handleClose}
            className="absolute right-4 top-[calc(1rem+env(safe-area-inset-top,0px))] md:top-4 flex h-8 w-8 items-center justify-center rounded-full bg-white text-gray-400 hover:text-gray-600 shadow-sm border border-orange-50/50 transition-all duration-200 cursor-pointer active:scale-90 z-10"
                ...
                {formats.map((fmt) => {
                  ...
                  return (
                    <button
                      ...
                      className={`flex items-center justify-start py-1.5 px-2 rounded-xl border transition-all duration-200 cursor-pointer select-none gap-2 active:scale-95 ${
                        isActive
                ...
                {socialChannels.map((channel) => {
                  ...
                  return (
                    <button
                      ...
                      className={`px-3 py-1 rounded-full text-[9px] font-bold transition-all border cursor-pointer active:scale-95 ${
                        isActive
