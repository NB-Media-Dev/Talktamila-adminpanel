    ...
    <div className="w-full">
      ...
      <div className="w-full bg-white rounded-[24px] sm:rounded-[32px] p-4 sm:p-8 shadow-[0_8px_30px_rgba(0,0,0,0.02)] border border-[#FFEFE0] transition-all duration-300 hover:shadow-[0_12px_40px_rgba(255,107,53,0.06)] relative overflow-hidden group">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <span className={`self-start sm:self-auto ${buttonVariants({variant:'default'})} text-[10px] sm:text-xs font-bold py-1.5 px-4 rounded-full tracking-wider uppercase shadow-xs`}>
            Live Update
          </span>
        </div>
        ...
        <div>
          <button className={`inline-flex items-center ${buttonVariants({variant:'default'})} gap-2 font-bold py-3 sm:py-3.5 px-6 sm:px-8  text-xs sm:text-base  shadow-md hover:shadow-lg cursor-pointer select-none group/btn`}>
