...
import { Clock, Trash2, MoreHorizontal, Film, ArrowRight, Play } from "lucide-react";
...
const initialQueueItems: QueueItem[] = [
  {
    ...
    status: "Scheduled",
    platform: "youtube",
    title: "Chennai Metro Phase II...",
    type: "AI Shorts • 45s",
    thumbnail: "https://images.unsplash.com/photo-1626125345510-4603468eedfb?w=300&auto=format&fit=crop&q=80", // Busy Indian street/metro vibe
  },
  {
    id: "2",
    time: "Today, 09:30 AM",
  ...
  },
  {
    ...
    type: "Reel • 30s",
    thumbnail: "https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?w=300&auto=format&fit=crop&q=80", // Tech/Neon theme
  },
];
    ...
    <div className="w-full flex flex-col gap-6 mb-8">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          <h2 className="text-2xl text-gray-900 tracking-tight">Queue</h2>
          <span className="bg-[#EAEFF5] text-[#2C3E50]/70 text-[10px] sm:text-xs font-bold py-1 px-3 rounded-full tracking-wider">
              ...
              >
                ...
                <div className="flex items-center justify-between w-full">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex flex-col">
                      <span className=" text-gray-900 text-sm">{item.time}</span>
                      <span
                  ...
                  <div>
                    {item.platform === "youtube" ? (
                      <div className="flex items-center gap-1.5 px-3 py-1 bg-[#ECEFF1] rounded-full text-xs font-semibold text-gray-700 shadow-inner-xs">
                        <Play className="w-3.5 h-3.5 text-red-600 fill-red-600 animate-pulse" />
                        <span>YouTube</span>
                      </div>
                    ) : (
                      <div className="flex items-center gap-1.5 px-3 py-1 bg-[#FFF0F3] rounded-full text-xs font-semibold text-gray-700 shadow-inner-xs">
                        <svg
                ...
                <div className="flex items-center gap-4 py-1">
                  ...
                  <div className="flex flex-col gap-1">
                    <h3 className="font-bold text-gray-900 text-[17px] leading-tight tracking-tight">
                      {item.title}
                    </h3>
                    <div className="flex items-center gap-1 text-gray-500 text-xs mt-0.5 font-semibold">
