...
import { Barcharticons, ClockIcons, HeartIcon, IndianrupeeIcons, LocationsIcons, MessageIcons, SavedIcons, SendIcon, SparkleIcons, TrendingIcons, YoutubeIcon } from "@/public/Svgicons/svgicons";
    ...
    <div className="w-full bg-white rounded-[32px] p-5 shadow-[0_4px_24px_rgba(0,0,0,0.03)] border border-[#FFEFE0] flex flex-col gap-4">
      ...
      {isInfluencer || isFreelancer ? (
        <InfluencerPostAnalytics
          ...
          expectedReach="200K – 350K"
          trendingProb="Very High"
          seoScore="94"
          qualityScore="96"
        />
      ) : (
